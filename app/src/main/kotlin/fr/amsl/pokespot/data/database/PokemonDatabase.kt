...
class PokemonDatabase : SQLiteOpenHelper {
  ...
  override fun onCreate(database: SQLiteDatabase?) {
    ...
    database?.insert(PokemonModel.TABLE_POKEMON, null, PokemonModel.Builder()
        ...
        .nameDe(context.getString(R.string.all_name_de))
        .nameEs(context.getString(R.string.all_name_es))
        .nameIt(context.getString(R.string.all_name_it))
        .nameJa(context.getString(R.string.all_name_ja))
